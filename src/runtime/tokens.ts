/* ══════════════════════════════════════════════════════
   OKLCH Token System — V6 Cool Gray

   Every color is derived from cool gray (h=240, low chroma).
   No warm grays, no pure white, no pure black.
   ══════════════════════════════════════════════════════ */
...
export const N = {
  chrome:     oklch(0.980, 0.002, 240),  // shell surface (not pure white)
  chromeSub:  oklch(0.950, 0.004, 240),  // active rows, controls
  ...
  txtPri:     oklch(0.200, 0.005, 240),  // primary text (not pure black)
