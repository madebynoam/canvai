/* ══════════════════════════════════════════════════════
   V3 Experimental Token System

   Changes from V2:
   - Chrome → white (L=1.000)
   - Accent → charcoal (h=80, low chroma, dark lightness)
   ══════════════════════════════════════════════════════ */
...
/* Warm neutrals — h=80, c=0.003 — chrome now white */
export const N = {
