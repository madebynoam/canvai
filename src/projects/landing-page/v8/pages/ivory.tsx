...
// ── Ivory — Codex Warm Tint (V8 Context) ──────────────────────────────────────
// Based on Codex context: same structure but warm peach/cream gradients.
// Tabbed layout, card-based features, centered hero.

const C = {
  bg: 'oklch(0.985 0.008 60)',
  bgGradient1: 'oklch(0.920 0.060 60)',
  bgGradient2: 'oklch(0.900 0.080 40)',
  bgCard: 'oklch(1.000 0 0)',
  text: 'oklch(0.200 0.030 50)',
  textSec: 'oklch(0.500 0.020 50)',
  border: 'oklch(0.920 0.015 60)',
  accent: 'oklch(0.550 0.150 40)',
}
    ...
    <div style={{ background: C.bg, minHeight: '100%', overflow: 'auto', fontFamily: font, WebkitFontSmoothing: 'antialiased' }}>
      ...
      <div style={{
        ...
        <nav style={{
          ...
          <button {...bhB} style={{
            ...
            cursor: 'default', boxShadow: '0 2px 8px oklch(0.2 0.02 50 / 0.1)',
          ...
          {tabs.map(t => (
            <button
              ...
              style={{
                ...
                cursor: 'default',
                boxShadow: activeTab === t.id ? '0 4px 12px oklch(0.2 0.02 50 / 0.15)' : 'none',
      ...
      <section style={{ padding: '0 64px', maxWidth: 1000, margin: '-40px auto 0' }}>
        <div {...ihB} style={{
          ...
          boxShadow: ih
            ? '0 24px 64px oklch(0.2 0.02 50 / 0.18)'
            : '0 12px 40px oklch(0.2 0.02 50 / 0.1)',
      ...
      <section style={{
        ...
        <button style={{
          ...
          cursor: 'default', boxShadow: '0 4px 12px oklch(0.2 0.02 50 / 0.2)',
