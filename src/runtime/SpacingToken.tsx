...
export function SpacingToken({ value, label, sublabel, tokenPath }: SpacingTokenProps) {
      ...
      >
        <div style={{ position: 'relative', flexShrink: 0 }}>
          <div style={{
            ...
            <div style={{
              width: tokenPath ? `min(24px, max(4px, calc(var(${tokenPath}) * 0.75)))` : Math.min(24, Math.max(4, displayValue * 0.75)),
              height: 8,
