...
const SUCCESS_BG = 'oklch(0.95 0.04 155)'
...
function StepBadge({ step }: { step: number }) {
  return (
    <div style={{
      ...
      color: 'oklch(1 0 0)', fontSize: T.pill, fontWeight: 700, fontFamily: FONT,
      display: 'flex', alignItems: 'center', justifyContent: 'center',
      flexShrink: 0,
    }}>
      {step}
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            position: 'absolute', bottom: S.lg, right: S.lg,
            width: 40, height: 40, borderRadius: '50%', border: 'none',
            backgroundColor: phase === 'targeting' ? N.txtPri : A.accent, color: 'oklch(1 0 0)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            boxShadow: '0 2px 8px rgba(0,0,0,0.2)',
            cursor: 'default',
          }}>
      ...
      <MiniCanvas style={{ width: 380, height: 200 }}>
        ...
        <div style={{ position: 'absolute', top: 16, left: 84 }}>
          ...
          <div style={{
            ...
            color: 'oklch(1 0 0)', fontSize: 9, fontWeight: 700, fontFamily: FONT,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
        ...
        <LegendRow>
          <div style={{ position: 'relative' }}>
            ...
            <div style={{
              ...
              color: 'oklch(1 0 0)', fontSize: 7, fontWeight: 700, fontFamily: FONT,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
        ...
        <LegendRow>
          <div style={{ opacity: 0.5 }}>
            <div style={{
              ...
              <Check size={10} strokeWidth={2} color="oklch(1 0 0)" />
            </div>
          </div>
          <span>Resolved</span>
        </LegendRow>
