...
function PickerRow({ project, active, onClick }: {
  ...
  return (
    ...
    >
      ...
      {active && <Check size={ICON.md} strokeWidth={1.5} color="var(--accent)" />}
    </button>
  )
}
    ...
    <div ref={containerRef} style={{ position: 'relative', fontFamily: FONT }}>
      <button
        ...
        style={{
          ...
          background: triggerHovered ? 'rgba(255, 255, 255, 0.06)' : 'transparent',
          border: 'none', borderRadius: R.control,
      ...
      >
        ...
        <span style={{ fontSize: T.title, fontWeight: 500, color: 'var(--txt-pri)' }}>
          {active.project}
        </span>
      ...
      <div style={{
        ...
        background: 'var(--card)', borderRadius: R.card,
