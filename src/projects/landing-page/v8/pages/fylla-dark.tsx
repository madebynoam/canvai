/* ------------------------------------------------------------------ */
/*  Fylla Dark — Editorial serif, deep charcoal, portrait grid        */
...
const S = {
  ...
  textMuted: 'oklch(0.60 0.01 80)',
  accent: 'oklch(0.25 0.015 260)',
  warm: 'oklch(0.22 0.015 260)',
...
function PortraitGrid() {
  return (
    <section style={{
      ...
      {/* Tall portrait left */}
      <div style={{
        background: 'linear-gradient(180deg, oklch(0.55 0.08 50) 0%, oklch(0.45 0.1 40) 100%)',
        borderRadius: 8,
        gridRow: 'span 2',
      }} />
      {/* Two smaller on right */}
      <div style={{
        background: 'oklch(0.58 0.06 140)',
        borderRadius: 8,
      }} />
      <div style={{
        background: 'oklch(0.68 0.04 80)',
        borderRadius: 8,
      }} />
      {/* Bottom row */}
      <div style={{
        background: 'oklch(0.52 0.05 200)',
        borderRadius: 8,
        gridColumn: 'span 2',
      }} />
    </section>
      ...
      <div style={{
        ...
        {[
          ...
          <div key={i}>
            <div style={{
              height: 280,
              background: i % 2 === 0 ? 'oklch(0.50 0.06 180)' : 'oklch(0.62 0.05 60)',
              borderRadius: 8,
              marginBottom: 16,
            }} />
            <h4 style={{
