  ...
  return (
    <button
      ...
      style={{
        ...
        backgroundColor: active ? N.chromeSub : hovered ? 'rgba(255,255,255,0.06)' : 'transparent',
...
export function ColorPicker({ l: initL, c: initC, h: initH, onChange, onApply, onCancel, onDiscard }: ColorPickerProps) {
  ...
  return (
    <div style={{
      ...
      borderRadius: R.card,
      padding: S.lg,
      boxShadow: `0 ${S.xs}px ${S.xxl}px rgba(0,0,0,0.24), 0 1px ${S.xs}px rgba(0,0,0,0.12)`,
        ...
        {onDiscard && (
          <button
            ...
            style={{
              ...
              background: discardHover ? 'rgba(255,255,255,0.08)' : 'transparent',
